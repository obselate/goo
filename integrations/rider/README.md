...
1. Install the CLI and standalone inspector with `dotnet tool install --global Goo.DevTools --version 0.6.5` and `dotnet tool install --global Goo.DevTools.App --version 0.6.5`.
