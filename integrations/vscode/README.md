...
```sh
dotnet tool install --global Goo.DevTools --version 0.6.2
dotnet tool install --global Goo.DevTools.App --version 0.6.2
```
...
code --install-extension goo-devtools-0.6.2.vsix
```
