...
3. Add the dated release entry to `CHANGELOG.md`. The tag workflow publishes
   only this version's entry as the GitHub Release notes. Build Goo in Release mode,
