...
class GalleryShaderPrograms {
    ...
    public init() {
        ...
        let ripple = ShaderEffectProgram.Load(Path.Combine(AppContext.BaseDirectory, "Shaders", "ripple.goo-effect"))
        ...
        let dither = ShaderEffectProgram.Load(Path.Combine(AppContext.BaseDirectory, "Shaders", "dither.goo-effect"))
        let aurora = ShaderEffectProgram.Load(Path.Combine(AppContext.BaseDirectory, "Shaders", "aurora.goo-effect"))
        let silk = ShaderEffectProgram.Load(
            Path.Combine(AppContext.BaseDirectory, "Shaders", "iridescent_silk.goo-effect")
        )
        let crt = ShaderEffectProgram.Load(Path.Combine(AppContext.BaseDirectory, "Shaders", "crt.goo-effect"))
