...
func Main() {
  Window.ConfigureApplication("Goo Gallery", "0.5.0", "io.github.obselate.goo.gallery")
  ...
  if Environment.GetEnvironmentVariable("GOO_GALLERY_CATEGORY_GATE") == "1" {
    RunCategoryGate()
    return
  }
  if Environment.GetEnvironmentVariable("GOO_GALLERY_CATEGORY_FRAME_TIMES") == "1" {
    RunGalleryCategoryFrameTimes()
    return
  }
  ...
  let reviewBench = Environment.GetEnvironmentVariable("GOO_GALLERY_REVIEW_BENCH") == "1"
  if smoke {
    RunSmoke()
    return
  }
