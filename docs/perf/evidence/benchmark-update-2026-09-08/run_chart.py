...
env.update(WAYLAND_DISPLAY='goo-chart-update-nested', SDL_VIDEODRIVER='wayland', VK_LOADER_LAYERS_DISABLE='~implicit~', GOO_VK_DIAGNOSTICS='1', GOO_GALLERY_REVIEW_BENCH='1', GOO_GALLERY_REVIEW_PACE16MS='1')
if args.validation:
