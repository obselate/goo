...
class DevToolsInputSmokeCell : Cell {
  ...
  override func Build() Blob -> Container {
    Width: Length.Percent(100), Height: Length.Percent(100), Padding: 24, Gap: 12,
    BackgroundColor: Color.Rgb(18, 24, 35), Color: Color.Rgb(235, 240, 250),
    Children: {
      Text{Key: "title", Content: "DevTools input verification", FontSize: 24},
      Button{Key: "button", Height: 40, Width: 220, BackgroundColor: Color.Rgb(35, 88, 150),
        OnClick: () -> { count++ }, Children: {Text{Content: "Activated " + count.ToString()}}},
      ...
      Container{Key: "columns", FlexDirection: FlexDirection.Row, Height: 70, Children: {
        Container{Key: "column", Width: columnWidth, Height: 70, BackgroundColor: Color.Rgb(40, 110, 92),
          Children: {Text{Content: "Width " + columnWidth.ToString()}}},
      ...
      Container{Key: "scroll", Width: 360, Height: 120, OverflowY: Overflow.Scroll,
        ScrollbarVisibility: ScrollbarVisibility.Always, BackgroundColor: Color.Rgb(30, 40, 58), Children: {
          Container{Height: 600, FlexShrink: 0, Children: {Text{Content: "Scrollable content", FontSize: 18}}},
        }},
    },
  }
}
