...
class PortalCaptureCell : Cell {
  ...
  override func Build() Blob -> Container() {
    ...
    Container() {
      ...
      .BorderStyle: BorderStyle.Solid,
      .BorderRadius: 18,
      .BorderWidth: Edges{Top: 4, Right: 8, Bottom: 10, Left: 6},
      .BorderColor: Edges[Color]{Top: Color.Rgb(220, 50, 50), Right: Color.Rgb(40, 190, 80), Bottom: Color.Rgb(40, 90, 220), Left: Color.Rgb(230, 190, 40)},
