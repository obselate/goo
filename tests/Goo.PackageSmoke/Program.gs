  ...
  override func Build() Blob {
    ...
    return Container {Width: Percent(100),Height: Percent(100),Handle: SmokeCell.Root,Padding: 12,Gap: 8,Position: PositionType.Relative,BackgroundColor: Color.Rgb(12, 20, 32),
      Text{
        ...
        Container {Width: 224,Height: 48,BackgroundImageSource: backgroundSource,BackgroundImageFit: ImageFit.Cover,BorderStyle: BorderStyle.Solid,
          BorderWidth: 2,
          BorderColor: Edges[Color](Color.Rgb(236, 128, 64), Color.Rgb(128, 236, 96), Color.Rgb(64, 160, 236), Color.Rgb(212, 96, 212)),
        Image{
              Width: 96,
              Height: 48,
              Source: imageSource,
        ...
        Container{
          ...
          BorderWidth: Edges{Top: 3, Right: 4, Bottom: 2, Left: 5},
          BorderColor: Edges[Color]{Top: Color.Rgb(224, 72, 72), Right: Color.Rgb(72, 224, 128), Bottom: Color.Rgb(72, 128, 224), Left: Color.Rgb(224, 184, 72)},
        },
        Container{
          Width: 224,
          Height: 20,
          BorderStyle: BorderStyle.Dotted,
          BorderWidth: Edges{Top: 2, Right: 3, Bottom: 4, Left: 3},
          BorderColor: Edges[Color]{Top: Color.Rgb(236, 128, 64), Right: Color.Rgb(128, 236, 96), Bottom: Color.Rgb(64, 160, 236), Left: Color.Rgb(212, 96, 212)},
        },
